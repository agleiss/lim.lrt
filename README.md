...
While so-called two-part tests compare mixture distributions between groups, one-part tests treat the zero-in?ated distributions as left-censored. The left-in?ated mixture model combines these two approaches. 
Assuming a log-normal subdistribution the left-in?ated mixture model provides estimates for the proportions of the two considered types of zero intensities.
